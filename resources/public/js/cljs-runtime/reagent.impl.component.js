...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21926 = c;
var G__21926__$1 = (((G__21926 == null))?null:G__21926.prototype);
if((G__21926__$1 == null)){
return null;
} else {
return G__21926__$1.reagentRender;
}
})() == null)))));
});
...
return (function() { 
var G__22102__delegate = function (args){
...
while (G__22103__i < G__22103__a.length) {G__22103__a[G__22103__i] = arguments[G__22103__i + 0]; ++G__22103__i;}
  args = new cljs.core.IndexedSeq(G__22103__a,0,null);
} 
return G__22102__delegate.call(this,args);};
...
return G__22102__delegate(args);
});
...
var or__5002__auto__ = (function (){var G__21965 = c;
var G__21965__$1 = (((G__21965 == null))?null:G__21965.constructor);
if((G__21965__$1 == null)){
return null;
} else {
return G__21965__$1.displayName;
}
})();
...
var G__21966 = c;
var G__21966__$1 = (((G__21966 == null))?null:G__21966.constructor);
if((G__21966__$1 == null)){
return null;
} else {
return G__21966__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21967 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21968 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21968);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21967);
}});
...
var c = this;
var G__21987_22111 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21987_22111 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21987_22111);
}
...
var renders_22113 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22114 = cljs.core.first(cljs.core.vals(renders_22113));
...
if((cljs.core.count(renders_22113) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22113))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22114)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22114], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22073 = o;
reagent.impl.component.goog$module$goog$object.set(G__22073,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22087 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22088 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22088);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22087);
}});
...
var vec__22089 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22089,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22089,(1),null);
...
var G__22092 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22092 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22092);
}
});
}),[]);
