...
var G__22822 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__22821,G__22822) : ajax.formats.get_format.call(null,G__22821,G__22822));
} else {
...
return cljs.core.some((function (p1__22825_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__22825_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__22826){
var map__22827 = p__22826;
var map__22827__$1 = cljs.core.__destructure_map(map__22827);
var request = map__22827__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22827__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__22830 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__22830.cljs$core$IFn$_invoke$arity$1 ? fexpr__22830.cljs$core$IFn$_invoke$arity$1(response) : fexpr__22830.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__22832){
var map__22837 = p__22832;
var map__22837__$1 = cljs.core.__destructure_map(map__22837);
var request = map__22837__$1;
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__22831_SHARP_){
return ajax.formats.get_accept_entries(request,p1__22831_SHARP_);
