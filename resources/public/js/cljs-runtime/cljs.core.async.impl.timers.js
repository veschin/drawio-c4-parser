...
var i_14535 = (0);
while(true){
if((i_14535 < arr.length)){
(arr[i_14535] = null);

var G__14536 = (i_14535 + (1));
i_14535 = G__14536;
continue;
} else {
}
...
var i_14550 = (self__.level + (1));
while(true){
if((i_14550 <= (new_level + (1)))){
(update[i_14550] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14554 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14554[i]));
} else {
x__$2.forward.push((((i < links_14554.length))?(links_14554[i]):null));
}

if((i < links_14554.length)){
(links_14554[i] = x__$2);
} else {
links_14554.push(x__$2);
}
...
var i_14560 = (0);
while(true){
if((i_14560 <= self__.level)){
var links_14561 = (update[i_14560]).forward;
if((x__$1 === (((i_14560 < links_14561.length))?(links_14561[i_14560]):null))){
(links_14561[i_14560] = (x__$1.forward[i_14560]));

var G__14563 = (i_14560 + (1));
i_14560 = G__14563;
continue;
} else {
var G__14566 = (i_14560 + (1));
i_14560 = G__14566;
continue;
}
} else {
