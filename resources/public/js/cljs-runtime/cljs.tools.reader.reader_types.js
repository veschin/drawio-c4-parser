...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_22171 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_22171(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_22172 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_22172(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22173 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_22173(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22174 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_22174(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22175 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_22175(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22176 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_22176(reader);
}
});
...
var G__22187 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__22188 = s.append(c);
c = G__22187;
s = G__22188;
continue;
}
